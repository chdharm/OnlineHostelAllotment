...
<div class="col-md-12" style="height:50px">RAW</div>
...
<div class="col-md-12" style="height:50px; background-color:#333333">
	...
	<div class="col-md-2" style="color:;font-weight:bold;margin-top:20px;background-color:">
	<li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="newvs.html">New VS Hostel</a></li>
...
<div class="container-fluid bg-1 text-center">
  ...
  <div class="row">
    <div class="col-sm-4">
      <img src="img/Hostels/VSHostel/picture (1).png" class="img-circle" width="290" height="236" alt="Image">
     
    </div>
    <div class="col-sm-4"> 
      <img src="img/Hostels/VSHostel/picture (2).png" class="img-circle" width="290" height="236" alt="Image">
      
    </div>
    
	 <div class="col-sm-4">
      <img src="img/Hostels/VSHostel/picture (3).png" class="img-circle" width="290" height="236" alt="Image">
...
<h3><center>Highlights </center></h3>
<p>
     <div  class="col-md-12">
  <ol class="list-group" style="list-style-type:disc">
 <li>VS hostel is named after the great Indian engineer,M. Visvesvaraya. His birthday is celebrated as the 'National Engineers Day' all over the nation on 15th September. </li>
  <li> The warden of Ramanujam hostel is Prof. A.K.Chauhan. He is one of the eminent faculties of the Mechanical Department of KNIT.</li>
 <li>Ramanujam hostel is meant for the allotement of first year students in addition to the Kalaam hostel.</li>
 <li>The hostel is a three seater one with two two floors.</li>
  <li>The hostel has a capacity to accomodate almost 160 students.</li>
 <li> It has its own mess facility. It has its own canteen facility, 'Quality'. </li>
  <li>It is the oldest hostel of KNIT  Sultanpur. </li>
     </ol>
	 </div>
   </p>
</div>
